...
class player_controller(Controller):
    ...
    def control(self, inputs, controller):
        ...
        if self.n_hidden[0]>0:
            ...
            # OLD: bias1 = controller[:self.n_hidden[0]].reshape(1,self.n_hidden[0])
            #print("NEW RESULT:")
            #print(controller[:self.n_hidden[0]])
            #print(type(controller[:self.n_hidden[0]]))
   
            # Convert controller list to numpy array
