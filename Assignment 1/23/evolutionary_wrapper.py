...
class EvolutionWrapper:
    ...
    def __init__(self, individual_array_size, mutation_operator: MutationOperators, mutation_arguments: dict, 
                 population_size: int, environment: Environment, crossover_operator: CrossoverOperators,
                 selection_operator: SelectionOperators, run_number: str, method_number: str):
        self._current_pop = []
    ...
    def __initialize_toolbox(self):
        ...
        self._toolbox.register("select", self._selection_operator, k=self._population_size, tournsize = 20, fit_attr='fitness')
